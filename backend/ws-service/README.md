...
-   Agents, tools, and LATS live in the shared `pipeline/` package (imported via PYTHONPATH). This service only hosts the WebSocket entrypoint and artifacts/log streaming.
