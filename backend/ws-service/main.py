...
REPO_ROOT = BASE_DIR.parents[1]  # Chat3GPP root
PIPELINE_DIR = REPO_ROOT / "pipeline"
if str(PIPELINE_DIR) not in sys.path:
    sys.path.insert(0, str(PIPELINE_DIR))
# Make pipeline location available to downstream modules
os.environ.setdefault("PIPELINE_ROOT", str(PIPELINE_DIR))
os.environ.setdefault("PIPELINE_ARTIFACTS_DIR", str(PIPELINE_DIR / "output" / "artifacts"))
